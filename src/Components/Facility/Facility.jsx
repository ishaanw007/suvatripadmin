      ...
      <div className="pt-5 tracking-wider">
        ...
        >
          <div className="border-b-[1px] border-slate-300">
            <h3 className="text-[35px] font-[600] tracking-wider">
              Facilities
            </h3>
          ...
          <div className="border-b-[1px] border-slate-300 pb-1 cursor-pointer">
            ...
            <div className="px-3">
              ...
              <input
                ...
                onChange={handleAccommodationChange}
              />
              <label for="Lift" className="text-[17px] my-[2px] mx-2">
                Lift
              </label>
              <br />
              <input
                ...
                onChange={handleAccommodationChange}
              />
              <label for="Room services" className="text-[17px] my-[2px] mx-2">
                Room services
              </label>
              <br />
          ...
          <div className="border-b-[1px] border-slate-300 pb-1 cursor-pointer">
            ...
            <div className="px-3">
              ...
              <input
                ...
                onChange={handleRecreationChange}
              />
              <label for="Fitness center" className="text-[17px] my-[2px] mx-2">
                Fitness center
              </label>
              <br />
              <input
                ...
                onChange={handleRecreationChange}
              />
              <label for="Spa" className="text-[17px] my-[2px] mx-2">
                Spa
              </label>
              <br />
              <input
                ...
                onChange={handleRecreationChange}
              />
              <label for="Beach" className="text-[17px] my-[2px] mx-2">
                Beach
              </label>
              <br />
            </div>
