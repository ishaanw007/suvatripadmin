          ...
          <div>
            ...
            <div className="mx-[0] my-5 md:mx-auto w-full md:w-[500px] px-3 md:px-0">
              ...
              <p className="fs-6 lh-lg">
                Welcome to SuvaTrip, please enter the deatils to continuee
              </p>
              <div className="w-full">
                ...
                <p className="lh-lg fs-6 text-capitalize underline">
                  <a href="./index.html">have trouble sign-up</a>
                </p>
                <button
                  type="button"
                ...
                <p className="text-[16px] lh-lg">
                  ...
                  <span className="text-[#ff5f63]">terms and condition</span> or{" "}
                  <span className="text-[#ff5f63]">privacy policy</span>{" "}
                </p>
                <p className="text-[16px] lh-lg">
                  Question about property or the extranet? checkout{" "}
                  <span className="text-[#ff5f63]">partner help</span> or ask
