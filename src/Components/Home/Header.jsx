...
import ViewImg from '../../Assets/img/ViewImages.png'


function Header() {
    return (
        <header>
            <div style={{ backgroundImage: `url(${ViewImg})`, fontFamily: `'Josefin Sans', sans-serif` }} className='w-full h-[700px] bg-center  py-60 md:py-40 px-8 md:px-16'>
