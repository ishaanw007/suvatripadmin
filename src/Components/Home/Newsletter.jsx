      ...
      >
        <div className="w-full md:w-[1000px] bg-[#ffebeb] mx-auto px-2 md:px-16 py-3 md:py-10 rounded-lg">
          <div className="text-center">
            <h3 className="text-[25px] md:text-[35px] p-2 font-[400] md:font-[600]">
              Want to Stay informed?
            </h3>
            <p className="py-1 px-2 md:px-10">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet
              dolores cupiditate dolore iste ab consequuntur rerum non facilis
