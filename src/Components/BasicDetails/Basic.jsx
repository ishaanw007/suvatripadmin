                ...
                <div>
                    <div className='px-2 md:px-5 py-2 border-b-[1px] border-slate-300'>
                        ...
                        <div className='my-2'>
                            ...
                            <div className="input-group w-full md:w-[400px]">
                                ...
                                >
                                    ...
                                    <option value="Guesthouse / bed and breakfast">Guesthouse / bed and breakfast</option>
                                    ...
                                    <option value="Holiday Park/caravan park">Holiday Park/caravan park</option>
                        ...
                        <div className='my-2 tracking-wider cursor-pointer'>
                            <p className='text-[20px] font-[400] my-2 text-slate-500'>What is the star rating of your hotel?</p>
                            <div>
                                <input
                                    type="radio"
                                    id="N/A"
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="N/A" className='m-1'>N/A</label><br />
                                {[1, 2, 3, 4, 5].map((rating) => (
                                    <React.Fragment key={rating}>
                                        <input
                                            ...
                                            onChange={handleChange}
                                        />
                                        <label htmlFor={rating} className='m-1'>{rating} star</label>
                                        {[...Array(rating)].map((_, index) => (
                                            <FaStar key={index} className='inline text-[#D5AB55]'
                                                style={{ color: formData.starRating >= rating ? '#D5AB55' : '#E4E5E7' }} />
                                        ))}
                                        <br />
                                    </React.Fragment>
                                ))}
