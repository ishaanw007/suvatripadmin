...
function Transport() {
    ...
    return (
        <div style={{ fontFamily: `'Josefin Sans', sans-serif` }} className='w-full md:w-[1000px] pt-5'>
            ...
            {/* Provide service */}
            <div className='py-2'>
                <p className='text-[14px] font-[600] my-2 text-slate-600 uppercase'>Do you provide pickup service to guests?</p>
                <input
                    type="radio"
                    id="yes"
                ...
                />
                <label htmlFor="yes" className='mx-1 my-1 text-slate-500'>Yes</label><br />
                <input
                    type="radio"
                    id="No"
                    name="providePickUpService"
            ...
            <div>
                ...
                />
                <label htmlFor="Free" className='mx-1 my-1 text-slate-500'>Free</label><br />
                <input
                    type="radio"
                    id="Payable"
                    name="chargeType"
                    ...
                    onChange={handleChargeTypeChange}
                />
                <label htmlFor="Payable" className='mx-1 my-1 text-slate-500' >Payable</label><br />
            </div>
